...
app.MapGet("/employees/search",(string q) => Employee.Search(q));           //q for query string

app.MapGet("/employees/{id:int}", (int id) => new Employee().GetOneEmployee(id));
//--------------------
app.MapPost("/employees/", (Employee employee) => Employee.CreateOneEmployee(employee));
...
class Employee(){
    ...
    private static List<Employee> Employees = new List<Employee>()
    {
        ...
        new Employee(){ Id = 2,FullName = "Sila Bulut",Salary = 70_000},
